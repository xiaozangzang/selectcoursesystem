...
if ((isset($_POST["MM_update"])) && ($_POST["MM_update"] == "form1")) {
  $updateSQL = sprintf("UPDATE student SET stuname=%s, collegename=%s, major=%s, sex=%s, `class`=%s WHERE stuid=%s",
...
<div align="center" width="1000">
    <p><a href="manage-stu.php">返回</a></p>
    <label >请进行学生信息的修改并保存：</label>
</div>
...
<form id="form1" name="form1" method="POST" action="<?php echo $editFormAction; ?>">
  <table width="1000" border="1" align="center">
    ...
    <tr>
      ...
      <td align="center"><input name="collegename" type="text" id="collegeid" value="<?php echo $row_Recordset1['collegename']; ?>" size="15" /></td>
      <td align="center"><input name="major" type="text" id="major" value="<?php echo $row_Recordset1['major']; ?>" size="15" /></td>
      ...
      <td align="center"><input name="submit" type="submit" id="submit" onclick="validate();return false" value="保存" /></td>
    </tr>
  </table>
