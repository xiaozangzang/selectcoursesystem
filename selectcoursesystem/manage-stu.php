...
if ((isset($_POST["MM_insert"])) && ($_POST["MM_insert"] == "form1")) {
  $insertSQL = sprintf("INSERT INTO student (stuname, collegename, major, sex, `class`, stupassword) VALUES (%s, %s, %s, %s, %s, %s)",
...
<div>
  ...
  <p>添加学生信息：</p>
    	<form id="form1" name="form1" method="POST" action="<?php echo $editFormAction; ?>">
    	  <table width="1000" border="1" align="center">
    	    <tr>
    	      <td width="91" align="center">学生编号</td>
    	      <td width="75" align="center">姓名</td>
    	      <td width="130" align="center">学院名称</td>
    	    ...
    	    <tr>
    	      ...
    	      <td align="center"><input name="collegename" type="text" id="collegename" size="15" /></td>
  ...
  <div>
  	...
  	<form id="form2" name="form2" method="post" action="">
  	  <table width="1000" border="1" align="center">
  	    <tr>
  	      <td width="120" align="center">学生编号</td>
  	      <td width="143" align="center">姓名</td>
  	      <td width="162" align="center">学院名称</td></td>
