	...
	<div>
    	...
    	<form id="form1" name="form1" method="POST" action="<?php echo $editFormAction; ?>">
    	  <table width="1000" border="1" align="center">
    	    <tr>
    	      <td width="91" align="center">教师编号</td>
    	      <td width="75" align="center">姓名</td>
    	      <td width="43" align="center">性别</td>
    	      <td width="150" align="center">所属学院</td>
    	    ...
    	    <tr>
    	      ...
    	      <td width="93" align="center"><input name="collegename" type="text" id="collegename" size="15" /></td>
    	  ...
    	  <table width="1000" border="1" align="center">
    	    ...
    	    <?php do { ?>
   	        <tr>
   	          ...
   	          <td width="150" align="center"><?php echo $row_Recordset1['collegename']; ?></td>
   	          <td width="387" align="center"><?php echo $row_Recordset1['introduction']; ?></td>
   	          <td width="48" align="center"><a href="delete-tea.php?teaid=<?php echo $row_Recordset1['teaid']; ?>" onclick="return confirm('确定要删除吗？')">删除</a></td>
   	          <td width="48" align="center"><a href="modify-tea.php?teaid=<?php echo $row_Recordset1['teaid']; ?>">修改</a></td>
  	        </tr>
