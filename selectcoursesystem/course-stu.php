...
if ((isset($_POST["MM_insert"])) && ($_POST["MM_insert"] == "form1")) {
  $insertSQL = sprintf("INSERT INTO stucourse (stuid, stuname, collegename, major, `class`, teaid,teaname, courseid, classtime) VALUES (%s, %s, %s, %s, %s, %s, %s, %s, %s)",
...
<form action="<?php echo $editFormAction; ?>" id="form1" name="form1" method="POST">
    ...
    <table  width="400" border="1" style="display: none;" align="center">
      <tr>
      ...
      <tr>
        ...
        <td align="center"><input name="collegename" type="text" id="collegename" value="<?php echo $row_Recordset2['collegename']; ?>" size="15" readonly="readonly" /></td>
      </tr>
      <tr>
  ...
  <table width="1000" border="1" align="center">
    <tr>
      ...
      <td align="center" nowrap="nowrap">教师姓名</td>
    ...
    <?php do { ?>
      <tr>
        ...
        <td align="center" nowrap="nowrap"><?php echo $row_Recordset1['teaname']; ?></td>
        ...
        <td align="center" nowrap="nowrap"><a href="add-class.php?courseid=<?php echo $row_Recordset1['courseid']; ?>">选课</a></td>
      </tr>
