    	...
    	<form id="form1" name="form1" method="post" action="">
    	  <table width="1000" border="1" align="center">
    	    ...
    	    <?php do { ?>
              ...
              <td width="103" align="center"><a href="tea-delete-course.php?courseid=<?php echo $row_Recordset1['courseid']; ?>" onclick="return confirm('确定要删除吗？')" >删除</a></td>
          <td width="103" align="center"><a href="tea-modify-course.php?courseid=<?php echo $row_Recordset1['courseid']; ?>">修改</a></td>
  	        </tr>
