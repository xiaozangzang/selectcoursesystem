...
$teaname = -1;
if (isset($_SESSION['TEA_NAME'])) {
    $teaname = $_SESSION['TEA_NAME'];
}
...
if ((isset($_POST["MM_insert"])) && ($_POST["MM_insert"] == "form1")) {
  $insertSQL = sprintf("INSERT INTO course (coursename, teaid, teaname, selected, total, classtime, classroom, credit, shangketime, shiyantime) VALUES (%s, %s, %s, %s,%s, %s, %s, %s, %s, %s)",
...
<body>
	<div>
    	<h1>欢迎您，<?php echo $teaname ?>！请选择您要进行的操作：</h1>
    </div>
    <div>
    	...
    	<form id="form1" name="form1" method="POST" action="<?php echo $editFormAction; ?>">
    	  <table width="1000" border="1" align="center">
    	    <tr>
              ...
              <td width="96" align="center">教师姓名</td>
    	    ...
    	    <tr>
              ...
              <td align="center"><input name="teaname" type="text" id="teaname" value="<?php echo $_SESSION['TEA_NAME']; ?>" size="10" readonly="readonly" /></td>
    	    ...
    	    <tr>
    	      <td colspan="11" align="center"><input type="submit" name="submit" id="submit"   onclick="return confirm('确定要添加吗？')" value="添加" /></td>
   	        </tr>
  	      </table>
